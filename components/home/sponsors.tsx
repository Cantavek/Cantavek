...
const Sponsors = () => {
  ...
  <div className="sm:max-w-5xl pt-8 rounded-xl bg-white mx-4 sm:mx-8 md:mx-auto">
    ...
    <div className="sm:py-6 px-4 md:px-8 sm:24 flex flex-wrap justify-center items-center space-x-3">
      <div
