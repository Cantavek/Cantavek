...
const PricingCard = ({ name, price, accesses, selected = false, popular = false }: Props) => {
  return (
    <div className={cn("relative flex flex-col p-6 bg-white shadow-lg rounded-lg dark:bg-zinc-850 justify-between border", { "border-purple-500": selected })}>
