...
const Navbar = () => {
  ...
  <div className="flex md:order-2 space-x-3 items-center">
      <button type="button" className="text-white bg-gradient-to-r from-pink-500 to-purple-500  rounded-xl text-sm font-semibold px-4 py-2 text-center mr-3 md:mr-0 ">Follow</button>
